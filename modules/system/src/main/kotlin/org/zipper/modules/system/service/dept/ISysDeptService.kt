...
interface ISysDeptService {
     ...
     * @return 部门信息集合
     */
    fun selectDeptList(dept: SysDeptParam): List<SysDeptVo>
     ...
     * @return 部门树信息集合
     */
    fun selectDeptTreeList(dept: SysDeptParam): List<Tree<Long>>
     ...
     * @return 结果
     */
    fun checkDeptNameUnique(dept: SysDeptParam): Boolean
     ...
     * @return 结果
     */
    fun insertDept(bo: SysDeptParam): Int
     ...
     * @return 结果
     */
    fun updateDept(bo: SysDeptParam): Int
