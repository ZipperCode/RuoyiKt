package org.zipper.modules.system.service.post
...
import org.zipper.modules.system.mapper.SysPostMapper
import org.zipper.modules.system.mapper.SysUserPostMapper
...
class SysPostServiceImpl(
    ...
    override fun selectPagePostList(post: SysPostBo, pageQuery: PageQuery): TableDataInfo<SysPostVo> {
        ...
        val page = baseMapper.selectVoPage<SysPostEntity, SysPostVo>(pageQuery.build(), lqw)
    ...
    override fun selectPostAll(): List<SysPostVo> {
        return baseMapper.selectList(QueryWrapper()).convertList()
    }
    ...
    override fun selectPostById(postId: Long?): SysPostVo? {
        return baseMapper.selectById(postId).convert()
    }
    ...
    override fun insertPost(bo: SysPostBo): Int {
        val post = bo.convert<SysPostEntity>()
