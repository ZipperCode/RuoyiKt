package org.zipper.framework.web.interceptor
...
import org.zipper.framework.web.filter.RepeatedlyRequestWrapper
...
class PlusWebInvokeTimeInterceptor : HandlerInterceptor {
    ...
    private val invokeTimeTL: TransmittableThreadLocal<StopWatch> by lazy {
        TransmittableThreadLocal<StopWatch>()
    }
