package org.zipper.framework.security.handler
...
class GlobalExceptionHandler {
    ...
    fun handleMessageException(e: MessageException, request: HttpServletRequest?): R<String> {
        log.error(e.message)
        return R.fail(e.resultCode, e.message)
    }
